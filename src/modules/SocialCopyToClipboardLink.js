...
class SocialCopyToClipboardLink {
  ...
  initModule({ targetSelector }) {
    ...
    targetElements.forEach((target) => {
      ...
      const currentLanguage =
        document.documentElement.lang && document.documentElement.lang.includes("fr") ? "fr" : "en";
  ...
  createLink(currentLanguage) {
    ...
    const copyPostLink = this.languageStrings[currentLanguage]
      ? this.languageStrings[currentLanguage].copyPostLink
      : this.languageStrings["en"].copyPostLink;
