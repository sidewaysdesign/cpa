class SinglePopup {
  ...
  popupInit({ triggerSelector, targetSelector, appearClass = 'fadein', activeClass = 'active', removeClass = 'fadeout', closeButtonClass = 'closex', wrapperClass = 'singlepopup--wrapper', containerClass = 'singlepopup--container', delay = 750, createCloseButton = false, maxWidth = null }) {
